...
capture -- deck doctor
exited "doctor" 0
also "reports five warnings, and no problem" "5 warning(s)"
...
also "six artifacts, over four repositories" "6 artifact(s)"
ok "the shared rule is everywhere" -- test -f hello-cli/.claude/rules/deck-layering.md
...
says "unmount takes back all six" "6 removed · 0 left alone" \
