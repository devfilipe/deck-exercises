...
|---|---|---|
| `.deck/` | your machine | **no** — paths, hosts, evidence, and the scopes you have chosen |
| `ai-packs/`, `org-packs/` | the team, and the organisation | **yes** — the commands, decisions and rules |
